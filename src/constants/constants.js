...
export const TimeLineData = [
  ...
  {
    year: 2016,
    text: 'Changed the course to a bsC in system analyst, focused on software development',
  },
  { year: 2017, text: 'Software Engineer Intership in a startup called ECOD3' },
  { year: 2018, text: 'Finished my graduation in System Analyst' },
  { year: 2019, text: 'Frontend Engineer in Raincake' },
  { year: 2020, text: 'Head of Development in Raincake' },
  { year: 2021, text: 'Frontend Engineer at Runrun.it' },
];
